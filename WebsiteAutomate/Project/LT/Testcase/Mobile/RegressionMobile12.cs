...
namespace WebsiteAutomate.Project.LT
{
    ...
    public  class RegressionMobile12 : BaseTest
    {
        ...
        [Test]
        public void VerifyAllCompanyLinksFooterMobile()
        {
            //Start Report
            test = GlobalSetup.bt.extent.StartTest("Verify All company links on Footer Mobile version.");
            ...
            ReportLog("###4. Click DMCA and check redirect page.");
            ...
            ReportLog("###11. Click Advertising and check redirect page.");
