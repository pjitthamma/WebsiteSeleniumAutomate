...
namespace WebsiteAutomate.Project.LT
{
    ...
    public  class RegressionMobile13 : BaseTest
    {
        ...
        [Test]
        public void VerifyAllCompanyLinksHambergerMobile()
        {
            //Start Report
            test = GlobalSetup.bt.extent.StartTest("Verify All company links on Hamberger Mobile version.");

            ReportLog("###1. Landing to website homepage.");
            Driver.NavigateTo(LT_URL);
            ReportLog("###2. Click hamberger menu and check all company links redirect.");
