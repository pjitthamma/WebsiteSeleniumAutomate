...
namespace WebsiteAutomate.Project.LT
{
    ...
    public  class RegressionMobile11 : BaseTest
    {
        ...
        [Test]
        public void VerifyFacebookShareOnEachArticlesMobile()
        {
            //Start Report
            test = GlobalSetup.bt.extent.StartTest("Verify Facebook share feature on each article type Mobile version.");
            ...
            //Check url correct
            Assert.IsTrue(lt.IsFacebookWindowPopupDisplayedMobile("fake-stained-glass"), ErrorMessage.LT.WRONG_FACEBOOK_SHARED_URL);
            ...
            lt.ClickFacebookShareButton();
            //Check url correct
            Assert.IsTrue(lt.IsFacebookWindowPopupDisplayedMobile("holiday-peppermint-bark-smores"), ErrorMessage.LT.WRONG_FACEBOOK_SHARED_URL);
            //close facebook popup
            lt.ClosePopupFacebook();
            ...
            lt.ClickFacebookShareButton();
            //Check url correct
            Assert.IsTrue(lt.IsFacebookWindowPopupDisplayedMobile("unique-wedding-rings"), ErrorMessage.LT.WRONG_FACEBOOK_SHARED_URL);
            //close facebook popup
            lt.ClosePopupFacebook();
            ...
            lt.ClickFacebookShareButton();
            //Check url correct
            Assert.IsTrue(lt.IsFacebookWindowPopupDisplayedMobile("fastest-accelerating-cars-in-the-world"), ErrorMessage.LT.WRONG_FACEBOOK_SHARED_URL);
            //close facebook popup
            lt.ClosePopupFacebook();
            ...
            lt.ClickFacebookShareButton();
            //Check url correct
            Assert.IsTrue(lt.IsFacebookWindowPopupDisplayedMobile("susan-boyle-returns-americas-got-talent"), ErrorMessage.LT.WRONG_FACEBOOK_SHARED_URL);
            //close facebook popup
            lt.ClosePopupFacebook();
